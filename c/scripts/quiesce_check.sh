...
QUIESCE_MODEL_DIR_1="${QUIESCE_MODEL_DIR_1:-$HOME/models/GLM-5.2-int4-with-int8-mtp}"
QUIESCE_MODEL_DIR_2="${QUIESCE_MODEL_DIR_2:-$HOME/models/GLM-5.2-iliria-mixed-280}"
for D in "$QUIESCE_MODEL_DIR_1" "$QUIESCE_MODEL_DIR_2"; do
