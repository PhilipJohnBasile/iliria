...
def main() -> None:
    ...
    for key in (
        "ILI_CUDA", "ILI_GPU", "ILI_GPUS", "COLI_CUDA", "COLI_GPU", "COLI_GPUS", "CUDA_EXPERT_GB",
    ...
    modes = {
        "cpu_stream": {},
        "dense_cuda": {"ILI_CUDA": "1", "ILI_GPU": args.gpu, "CUDA_DENSE": "1"},
        "cpu_pin": {"PIN": str(stats), "PIN_GB": args.pin_gb},
        "cuda_pin": {
            "ILI_CUDA": "1", "ILI_GPU": args.gpu,
            "PIN": str(stats), "PIN_GB": args.pin_gb,
            "CUDA_EXPERT_GB": args.cuda_expert_gb,
        },
        "cuda_pin_dense": {
            "ILI_CUDA": "1", "ILI_GPU": args.gpu, "CUDA_DENSE": "1",
            "PIN": str(stats), "PIN_GB": args.pin_gb,
            "CUDA_EXPERT_GB": args.cuda_expert_gb,
        },
    }
